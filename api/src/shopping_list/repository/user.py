...
from shopping_list.auth import get_password_hash
from shopping_list.db.models import User
from shopping_list.schemas.user import UserCreate
...
def update(
    db_session: Session, *, db_user: User, user_to_update: dict, updated_by_admin: bool
) -> User:
