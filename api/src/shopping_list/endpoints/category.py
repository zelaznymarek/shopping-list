...
from shopping_list.auth import get_current_user
from shopping_list.db import models
from shopping_list.db.session import get_db
from shopping_list.repository import category as crud
from shopping_list.schemas import category as schemas
...
def update(
    ...
    return crud.update(
        ...
        category_to_update=category_to_update.dict(),
    )
