...
@router.post('/', response_model=schemas.User, responses={status.HTTP_401_UNAUTHORIZED: {}})
def add(
...
@router.delete('/', status_code=status.HTTP_204_NO_CONTENT, responses={status.HTTP_404_NOT_FOUND: {'description': 'User not found'}})
def delete_by_email(
