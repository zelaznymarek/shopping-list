...
@router.get('/{list_id}', response_model=schemas.ShoppingList, responses={status.HTTP_404_NOT_FOUND: {}})
def get_one(
        list_id: int,
...
@router.post('/', response_model=schemas.ShoppingList, responses={status.HTTP_422_UNPROCESSABLE_ENTITY: {}})
def add(
